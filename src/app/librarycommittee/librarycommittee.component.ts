...
@Component({
  selector: 'app-librarycommittee',
  templateUrl: './librarycommittee.component.html',
  styleUrls: ['./librarycommittee.component.css']
})
export class LibrarycommitteeComponent implements OnInit {
