...
@Component({
  selector: 'app-constructioncommittee',
  templateUrl: './constructioncommittee.component.html',
  styleUrls: ['./constructioncommittee.component.css']
})
export class ConstructioncommitteeComponent implements OnInit {
