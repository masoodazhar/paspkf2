...
@Component({
  selector: 'app-notifyessions',
  templateUrl: './notifyessions.component.html',
  styleUrls: ['./notifyessions.component.css']
})
export class NotifyessionsComponent implements OnInit {
