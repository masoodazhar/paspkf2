...
@Component({
  selector: 'app-specialcommittee',
  templateUrl: './specialcommittee.component.html',
  styleUrls: ['./specialcommittee.component.css']
})
export class SpecialcommitteeComponent implements OnInit {
