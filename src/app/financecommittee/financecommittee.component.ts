...
@Component({
  selector: 'app-financecommittee',
  templateUrl: './financecommittee.component.html',
  styleUrls: ['./financecommittee.component.css']
})
export class FinancecommitteeComponent implements OnInit {
